    ...
    class AdBlueMediaLocker {
        ...
        updateTitleWithContentName() {
            ...
            if (contentTitle) {
                ...
                if (titleElement) {
                    titleElement.innerHTML = `Install one of our sponsor apps below to continue watching <span class="content-name">${this.escapeHtml(contentTitle)}</span>.`;
                }
            }
        }
        ...
        addContentImage() {
            ...
            if (contentImage) {
                ...
                if (backdrop) {
                    // Add background image to backdrop as a soft cinematic wash
            ...
            return `
                <div class="adblue-locker-modal">
                    ...
                    <div class="adblue-locker-header">
                        ...
                        <h2 class="adblue-locker-title" id="adblue-locker-title">Install one of our sponsor apps below to continue watching.</h2>
                        <div class="locker-loadbar" aria-hidden="true">
                            <div class="locker-loadbar-track">
                                <div class="locker-loadbar-fill"></div>
                            </div>
                            <span class="locker-loadbar-label">Almost ready — complete the last step to start streaming</span>
                        </div>
                    </div>
                    ...
                    <div class="adblue-locker-content">
                        <div class="adblue-locker-offers-container">
                            ...
                            <div id="offers-container" class="offers-grid">
                                <!-- Sponsor apps will be loaded here dynamically -->
                            </div>
                            <div id="offers-error" class="offers-error" style="display: none;">
                                <i class="bi bi-exclamation-triangle"></i>
                                <p>Unable to load sponsor apps. Please refresh.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="adblue-locker-footer">
                        <p class="footer-note">
                            ...
                            Sponsored — installs keep NoirX free to stream
                        </p>
                    </div>
                </div>
            `;
